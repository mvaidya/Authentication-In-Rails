...
Sample code that demonstrates creating your own Authentication solution in Rails

This app builds authentication on top of the BaseApp included in this repository
